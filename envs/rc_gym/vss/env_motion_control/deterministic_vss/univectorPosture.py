...
def getVectorDirection(currentPosition, objectivePosition, robotPos, allies, enemies, index):
    direction = getSurroundings(currentPosition, objectivePosition, objectivePosition)
...
def update(ballPos, robotPos,objPos, allies, enemies, index):
    ...
    for _ in range(iterations):
        angle = getVectorDirection(curPos, objPos, robotPos, allies, enemies, index)
    ...
    angle = getVectorDirection(robotPos, objPos, robotPos, allies, enemies, index)
